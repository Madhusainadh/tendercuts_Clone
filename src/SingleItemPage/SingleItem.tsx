...
const SingleItem = () => {
  ...
  return (
    <div>
      <Box><Heading>{data.title}</Heading>
      <Text>{data.details}</Text></Box>
      <Flex>
        <Box>
...
<Text>{data.dis}</Text>
        ...
        <Flex><Box><span>Weight : </span><Text>{data.weight}</Text></Box>
        <Box><span>Serves : </span><Text>{data.Serves}</Text></Box>
        </Flex>
